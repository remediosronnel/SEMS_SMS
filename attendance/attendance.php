  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      <div class="navbar-header">
        <a class="navbar-brand">SSG ATTENDANCE</a>
    </div>
    <div class="container-fluid">
      <div class="navbar-header">
        <a class="navbar-brand" href="/SSG/attendance/show_attendance.php">BACK</a>
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            <?php
              ...
              $sql = "SELECT * FROM attentable where orgID = '0' and eventID = '$eventID'";
        ...
        <?php logActivity('0', $date, 'Create', 'User utilized attendance', $time); ?>                    
                </form>
                </form>
                  <tr>
                    <td><?php echo $i ?></td>
...
<?php 
  if(isset($_POST['text']) ){
           ...
           $sql = "SELECT * FROM studenttable WHERE studenttable.idNumber = '$text'";
           ...
           $sql5 = "SELECT * FROM eventtable where eventtable.eventID = '$eventID'";
           if (!empty($sql5)) {
           ...
           $sql1="SELECT COUNT(idNumber) AS count FROM attentable WHERE attentable.idNumber = '$text1' and eventID = '$eventID'";
           $query1 = $conn->query($sql1);
           $row = mysqli_fetch_assoc($query1);
       
       
           $sql = "SELECT * FROM attentable WHERE attentable.idNumber = '$text1' AND attentable.LogDate = '$date' AND attentable.Status = '0'";
           $query = $conn->query($sql);
           ...
           if(($row['count'] <= 1) && ($date < $curDate)){
               ...
               if(($query->num_rows > 0) AND (($row['count'] == 1))){
                   ...
                   $sql = "UPDATE attentable SET TimeOut = '$time', Status = '1' WHERE studentID = '$studentID' AND LogDate = '$date' AND eventID = '$eventID'";
                   $query = $conn -> query($sql);
                   $voice -> speak($message);
                  ...
                  header('Location: attendance.php');
                       ...
                       $sql = "INSERT INTO attentable(studentID, idNumber, StudentName, TimeIn, LogDate, Status, orgID, eventID, eventDescription) VALUES('$studentID', '$text1', '$studentName', '$time', '$date', '0', '$orgID', '$eventID','$eventDescription')";
